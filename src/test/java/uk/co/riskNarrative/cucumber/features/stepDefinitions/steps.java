...
public class steps extends BaseTest {
    ...
    public void i_tap_on(String financialServicesText) {
    ...
    public void i_should_not_see_the_cookie_banner() {
        ...
        log.info("Cookie Banner is not displayed");
    }
    ...
    public void i_tap_on_about_us_link(String aboutUsText) {
    ...
    @When("I should see the search result for Search all jobs button")
    public void i_should_see_the_search_result_for_search_all_jobs_button() {
        careersJobsPage = PageFactory.initElements(driver, CareersJobsPage.class);
        AssertionHelper.updateTestStatus(careersJobsPage.assertShowingResultsStatisticsSearchAllJobsIsDisplayed());
    ...
    @When("I tap {string} link")
    public void i_click_on_choose_your_industry_link(String itemNameFromTopMenu) {
        naviPage = PageFactory.initElements(driver, TopMenuNavigationPage.class);
        Assert.assertTrue(naviPage.assertAndClickAnItemFromTopMenu(itemNameFromTopMenu));
        //naviPage.clickAnItemFromTopMenu(itemNameFromTopMenu);
    }
    ...
    @Then("I can see an item in Financial Services {string}")
    public void financial_services_sub_title_is_displayed(String financialServicesItem) {
        indexPage = PageFactory.initElements(driver, IndexPage.class);
        AssertionHelper.updateTestStatus(indexPage.verifyFinancialServicesItemDisplayed(financialServicesItem));
    ...
    public void i_click_on_cookies_settings() throws InterruptedException {
        cookieBannerPage = PageFactory.initElements(driver, CookieBannerPage.class);
    ...
    public void i_should_see_strictly_necessary_cookies_is_always_active_by_default(String categoryName, String cookieValue) {
        ...
        log.info("Strictly Necessary Cookies is " + cookieValue);
    }
